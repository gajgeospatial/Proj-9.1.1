...
set(CPACK_IGNORE_FILES "/\\..*;/.*\\.yml;/.*\\.gz;/.*\\.zip;/.*build.*/;\\.deps;/autogen\\.sh;/autom4te\\.cache;/CODE_OF_CONDUCT.md;/CONTRIBUTING.md;/Dockerfile;/docs/;/Doxyfile;/examples/;/HOWTO-RELEASE;/m4/lt*;/m4/libtool*;/media/;/schemas/;/scripts/;/test/fuzzers/;/test/gigs/.*gie\\.failing;/test/postinstall/;/travis/;N:/Development/Dev_Base/proj-9.1.1/msvc")
set(CPACK_INSTALLED_DIRECTORIES "N:/Development/Dev_Base/proj-9.1.1;/")
...
set(CPACK_PACKAGE_FILE_NAME "proj-9.1.1")
...
set(CPACK_SOURCE_INSTALLED_DIRECTORIES "N:/Development/Dev_Base/proj-9.1.1;/")
